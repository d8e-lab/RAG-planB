...
epoch=$1
lstm_num_layers=$3
save_path=/mnt/82_store/sbc/planB/weights/bert-lstm/bert_nofreezed_mlp_${lstm_num_layers}lstm_mlp_relu_normalized_mean/${current_datetime}
# save_path=/mnt/82_store/sbc/planB/weights/single-bert/
